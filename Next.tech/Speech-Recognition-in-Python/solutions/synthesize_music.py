...
if __name__=='__main__':
    # Input file containing note to frequency mapping. You have been provided with a JSON file called tone_freq_map.json, which contains some notes along with their frequencies:
